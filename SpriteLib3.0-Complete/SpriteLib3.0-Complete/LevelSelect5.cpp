...
int LevelSelect5::GetMedal3()
{
	return m_medal3;
}

int LevelSelect5::GetMedal4()
{
	return m_medal4;
}

int LevelSelect5::GetMedal5()
{
	return m_medal5;
}

int LevelSelect5::GetLock1()
{
	return m_lock1;
}

int LevelSelect5::GetLock2()
{
	return m_lock2;
}

int LevelSelect5::GetLock3()
{
	return m_lock3;
}

int LevelSelect5::GetLock4()
{
	return m_lock4;
}