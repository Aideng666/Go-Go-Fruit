...
int LevelSelect4::GetMedal2()
{
	return m_medal2;
}

int LevelSelect4::GetMedal3()
{
	return m_medal3;
}

int LevelSelect4::GetMedal4()
{
	return m_medal4;
}

int LevelSelect4::GetMedal5()
{
	return m_medal5;
}

int LevelSelect4::GetLock1()
{
	return m_lock1;
}

int LevelSelect4::GetLock2()
{
	return m_lock2;
}

int LevelSelect4::GetLock3()
{
	return m_lock3;
}

int LevelSelect4::GetLock4()
{
	return m_lock4;
}