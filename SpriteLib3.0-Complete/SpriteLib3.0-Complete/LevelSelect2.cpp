...
int LevelSelect2::GetMedal2()
{
	return m_medal2;
}

int LevelSelect2::GetMedal3()
{
	return m_medal3;
}

int LevelSelect2::GetMedal4()
{
	return m_medal4;
}

int LevelSelect2::GetMedal5()
{
	return m_medal5;
}

int LevelSelect2::GetLock1()
{
	return m_lock1;
}

int LevelSelect2::GetLock2()
{
	return m_lock2;
}

int LevelSelect2::GetLock3()
{
	return m_lock3;
}

int LevelSelect2::GetLock4()
{
	return m_lock4;
}