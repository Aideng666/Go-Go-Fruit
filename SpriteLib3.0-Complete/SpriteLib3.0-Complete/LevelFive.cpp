...
void LevelFive::InitScene(float windowWidth, float windowHeight)
{
	...
	sndPlaySound("Level 3.wav", SND_FILENAME | SND_ASYNC | SND_LOOP);
...
#pragma region PLAYER ENTITIES
	//Blueberry
	{
		...
		tempPhsBody = PhysicsBody(tempBody, float(13), float(19), vec2(1.f, -9.5f), false);
	...
	//Watermelon
	{
		...
		tempPhsBody = PhysicsBody(tempBody, float(20), float(21), vec2(-1.f, -2.f), false);
